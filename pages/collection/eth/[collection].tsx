...
export const getServerSideProps = async ({ query }) => {
  ...
  const collection = await fetchCollection(query.collection, networkId);
  ...
  return (
    <>
      {!!collection ? (
        <>
          <Head>
            <title>{collection.name} | Kreatorland</title>
            <meta property="og:title" content={collection.name + " | Kreatorland"} />
        ...
        <>
          <Head>
            <title>Not Found | Kreatorland</title>
            <meta property="og:title" content={`Not Found | Kreatorland`} />
