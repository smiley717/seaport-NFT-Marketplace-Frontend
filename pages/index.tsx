...
const HomePage = ({ featured, collections }) => {
  ...
  return (
    <>
      <Head>
        <title>Kreatorland, the largest NFT marketplace on zkSync Era</title>
        <meta
          property="og:title"
          content={`Kreatorland, the largest NFT marketplace on zkSync Era`}
        />

        <meta
          name="description"
          content={`Discover, collect, and sell digital items on the largest NFT marketplace on zkSync Era. Transact in milliseconds and save up to 100x on gas fees.`}
        />
        <meta
